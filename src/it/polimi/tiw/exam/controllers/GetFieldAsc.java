...
/**
 * Servlet implementation class GetFieldAsc
 */
@WebServlet("/GetFieldAsc")
public class GetFieldAsc extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			if(user.getAccessRights().equals("Professor")) grades=gradeDAO.getGradesByFieldAsc(appId,field);
